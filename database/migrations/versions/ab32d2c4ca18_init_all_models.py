...
def upgrade() -> None:
    ...
    op.create_foreign_key(op.f('fk_org_user_link_organization_id_organizations'), 'org_user_link', 'organizations', ['organization_id'], ['organization_id'], source_schema='common', referent_schema='supervisor', ondelete='CASCADE')
    op.create_foreign_key(op.f('fk_org_user_link_user_id_users'), 'org_user_link', 'users', ['user_id'], ['user_id'], source_schema='common', referent_schema='user', ondelete='CASCADE')
    op.create_foreign_key(op.f('fk_partner_org_link_partner_id_partners'), 'partner_org_link', 'partners', ['partner_id'], ['id'], source_schema='common', referent_schema='partner', ondelete='CASCADE')
    op.create_foreign_key(op.f('fk_partner_org_link_organization_id_organizations'), 'partner_org_link', 'organizations', ['organization_id'], ['organization_id'], source_schema='common', referent_schema='supervisor', ondelete='CASCADE')
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(op.f('fk_partner_org_link_organization_id_organizations'), 'partner_org_link', schema='common', type_='foreignkey')
    op.drop_constraint(op.f('fk_partner_org_link_partner_id_partners'), 'partner_org_link', schema='common', type_='foreignkey')
    op.drop_constraint(op.f('fk_org_user_link_user_id_users'), 'org_user_link', schema='common', type_='foreignkey')
    op.drop_constraint(op.f('fk_org_user_link_organization_id_organizations'), 'org_user_link', schema='common', type_='foreignkey')
